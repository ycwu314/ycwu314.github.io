...
{% asset_img postman-oauth2.png %}

{% asset_img postman-get-access-token.png %}
...
{% asset_img refresh-token.png %}

响应为json。

# 四种授权模式的对比

{% asset_img OAuth-Flow-Comparison.png %}
